...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 grid w-[min(92vw,32rem)] -translate-x-1/2 -translate-y-1/2 gap-4 rounded-[2rem] border border-border/80 bg-background p-6 shadow-[0_30px_80px_-30px_rgba(10,13,25,0.65)] outline-none",
        className,
      )}
      {...props}
    >
